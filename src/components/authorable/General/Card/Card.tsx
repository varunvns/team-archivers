...
export type CardProps = ProjectArchive.DatasourceTemplates.Global.CardListCarousel.Fields.CardList & {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 ">
          {fields?.Cards?.map((Card: any, index:number) => (
             ...
             <div className="py-6 px-4 mt-11 bg-white mx-auto text-center">
               ...
               <Link href={Card?.url} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
               Click here
               </Link>
             </div>
           </div>
